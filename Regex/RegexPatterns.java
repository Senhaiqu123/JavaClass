...
public class RegexPatterns {
	...
	public static boolean testName(String name){
		return name.matches("([A-Z][A-Z]?[a-z]*)([-]([A-Z][A-Z]?[a-z]*))?[ ]*([A-Z][A-Z]?[a-z]*)([-]([A-Z][A-Z]?[a-z]*))?");
	}
	...
	public static boolean testEmail(String email){
		return email.matches("(\\p{Alpha})((\\p{Alpha})||([-_.]))*([@])((\\p{Alpha})((\\p{Alpha})||([-_.]))*)([.])((com)||(net)||(org))");
	}
	...
	public static boolean testAddress(String address){
		return address.matches("(([0-9]{1,5})([ ]+)((\\p{Alnum})||([- .]))+)([\r\n])(((\\p{Alpha})||([- .]))+)([ ]*)([,])?([ ]+)\\p{Alpha}\\p{Alpha}([ ]+)([0-9]{5}+)");
	}
